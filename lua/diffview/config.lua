...
M.defaults = {
  ...
  keymaps = {
    ...
    view = {
      ...
      { "n", "<leader>ce",  actions.conflict_choose("all"),         { desc = "Choose all the versions of a conflict" } },
      ...
      { "n", "<C-d>",       actions.smart_scroll_down(),            { desc = "Scroll down or next file at bottom" } },
      { "n", "<C-u>",       actions.smart_scroll_up(),              { desc = "Scroll up or prev file at top" } },
    ...
    file_panel = {
      ...
      { "n", "gr",             actions.toggle_hide_pure_renames,       { desc = "Hide files that were only renamed (no content changes)" } },
